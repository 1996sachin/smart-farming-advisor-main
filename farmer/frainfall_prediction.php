          ...
          <div class="row row-content">
            <div class="col-md-12 mb-3">
				...
				<form role="form" action="#" method="post" >  
				  ...
				  <span class=" text-color display-4" > Rainfall Prediction  </span>	
 ...
 <tbody>
                                 <tr class="text-center">
								   ...
								   <div class="form-group ">
                                    ...
                                    <center>
										<div class="form-group ">
											<button type="submit" value="Yield" name="Rainfall_Predict" class="btn text-white btn-submit">Predict</button>
										</div>
...
<div class="card text-white bg-gradient-success mb-3">
				  ...
				  <span class=" text-color display-4" > Result  </span>					
					...
					$command = escapeshellcmd("python3 ML/rainfall_prediction/rainfall_prediction.py $Jregion $Jmonth ");
