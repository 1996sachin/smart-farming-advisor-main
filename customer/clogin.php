...
<div class="col-sm-12 mb-3">  
  ...
  <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
    <a class="nav-item nav-link active font-weight-bold text-color" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Customer Login</a>
           ...
           <div class="card card-body bg-gradient-danger">
                 ...
                 <form method="POST" action="cloginScript.php">     
                    ...
                    <label for="email" class="col-md-3 col-form-label"
                      ><h6 class="text-dark font-weight-bold">Email Id</h6>
                    </label>
                    <div class="col-md-9">
                      <input
                        type="text"
                      ...
                      />
				  			  		 ...
				  			  		 <div class="form-group row">
                <label for="pass" class="col-md-3 col-form-label text-dark font-weight-bold" > Password </label>
			   <div class="col-9">
