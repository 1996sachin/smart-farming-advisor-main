    ...
    <div class="row">
      <div class="col-sm-12 mb-3">  
        <div class="nav nav-tabs nav-fill bg-gradient-default" id="nav-tab" role="tablist">
          <a class="nav-item nav-link active font-weight-bold text-color" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">User Signup</a>
        </div>
            ...
            <div class="card card-body bg-gradient-warning">
              <form name="insert" action="" method="post"  enctype="multipart/form-data">	
                ...
                <div class="form-group row">
                  <label for="staffid" class="col-md-3 col-form-label font-weight-bold text-dark">Customer Name<strong class="text-default"> *</strong></label>
                  <div class="col-md-9">
...
<option value="">Select district</option>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-9">
                    ...
                    <span class="text-light d-block">Use minimum 8 characters with at least 1 numerical, capital letter, and special character.</span>
                  </div>
                </div>
                ...
                <div class="form-group row">
                  ...
                  <div class="col-9">
                    <div class="input-group mb-3">
                      ...
                      <input name="confirmpassword" type="password" class="input form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" id="cpassword" placeholder="Confirm Password" required="true" aria-label="password" aria-describedby="basic-addon1" />
                      <div class="input-group-append">
